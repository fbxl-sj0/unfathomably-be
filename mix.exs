defmodule Pleroma.Mixfile do
  ...
  defp included_applications(:prod), do: [:ex_syslogger]
  ...
  defp warnings_as_errors do
    truthy_env?("CI") or truthy_env?("WARNINGS_AS_ERRORS")
  end
  ...
  defp deps do
    [
      ...
      {:csv, "~> 3.2"},
      {:tesla, "~> 1.21.0", override: true},
      {:castore, "~> 1.0"},
      {:cowlib, path: "vendor/cowlib", override: true},
      {:gun, path: "vendor/gun", override: true},
      {:finch, "~> 0.23"},
      {:jason, "~> 1.2"},
      {:jcs, "~> 0.2.0"},
      {:mogrify, "~> 0.9.1"},
      ...
      {:bbcode_pleroma, path: "vendor/bbcode_pleroma"},
      ...
      {:icalendar, "~> 1.1"},
      {:geospatial, "~> 0.3"},
      {:geo, "~> 4.1", override: true},
      {:tz_world, "~> 2.3", override: true},
      {:prom_ex, "~> 1.11"},
      {:peep, "~> 5.0", override: true},
      {:unplug, "~> 1.1"},
      {:certifi, "~> 2.12"},
  ...
  defp aliases do
    [
      ...
      "test.federation": [
        "test --warnings-as-errors --no-all-warnings test/pleroma/web/federation/platform_test.exs test/pleroma/web/mastodon_api/controllers/source_items_controller_test.exs test/pleroma/web/mastodon_api/controllers/local_group_controller_test.exs"
      ],
      "test.release_surface": [

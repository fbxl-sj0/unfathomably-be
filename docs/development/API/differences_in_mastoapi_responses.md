...
For the complete streaming protocol, including WebSocket transport,
authentication, dynamic subscriptions, and the `group` and `source`
extensions, see [Streaming protocol](streaming.md).

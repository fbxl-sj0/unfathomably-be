...
defmodule Pleroma.DataCase do
  ...
  def setup_multi_process_mode(%{needs_streamer: true} = tags) do
    owner =
      Ecto.Adapters.SQL.Sandbox.start_owner!(Pleroma.Repo,
    ...
    on_exit(fn ->
      Pleroma.Web.Streamer.wait_for_test_streams(test_pid)

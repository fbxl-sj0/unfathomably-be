...
defmodule Pleroma.Workers.BackgroundWorkerTest do
  ...
  test "cancels malformed background jobs instead of retrying them" do
  ...
  test "routes slow deletion jobs through the delete worker" do
    assert {:cancel, :user_not_found} =
             DeleteWorker.perform(%Oban.Job{

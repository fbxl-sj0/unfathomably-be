...
defmodule Pleroma.ConfigTest do
  ...
  describe "nil values" do
    setup do
      ...
      dolor_config = [sit: %{amet: nil}]

      clear_config(:dolor, dolor_config)
  ...
  test "delete/2 with a list of keys" do
    delete_me_config = [hello: "world", world: "Hello"]

    clear_config([:delete_me], delete_me_config)
    Pleroma.Config.delete([:delete_me, :world])
    assert Pleroma.Config.get([:delete_me]) == [hello: "world"]

    clear_config([:delete_me, :delete_me], delete_me_config)
  ...
  test "fetch/1" do
    ...
    ipsum_config = [dolor: :sit]

    clear_config([:ipsum], ipsum_config)

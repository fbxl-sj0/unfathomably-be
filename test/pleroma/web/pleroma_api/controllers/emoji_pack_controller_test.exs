  ...
  describe "POST /api/pleroma/emoji/packs/download" do
    ...
    test "shared pack from remote and non shared from fallback-src", %{
      ...
      mock(fn
        ...
        %{
          method: :get,
          url: "https://example.com/api/v1/pleroma/emoji/pack?name=test_pack&page_size=" <> _
        } ->
          conn
        ...
        %{
          ...
          conn
          |> get("/api/pleroma/emoji/pack?name=test_pack_nonshared&page_size=1")
          |> json_response_and_validate_schema(200)
          |> json()
    ...
    test "checksum fail", %{admin_conn: admin_conn} do
      mock(fn
        ...
        %{
          method: :get,
          url: "https://example.com/api/v1/pleroma/emoji/pack?name=pack_bad_sha&page_size=" <> _
        } ->

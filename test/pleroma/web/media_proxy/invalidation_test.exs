...
defmodule Pleroma.Web.MediaProxy.InvalidationTest do
  ...
  describe "Invalidation.Http" do
    test "perform request to clear cache" do
      ...
      invalidation_config = [method: :purge, headers: [{"x-refresh", 1}]]

      clear_config([Invalidation.Http], invalidation_config)
  ...
  describe "Invalidation.Script" do
    test "run script to clear cache" do
      ...
      invalidation_config = [script_path: "purge-nginx"]

      clear_config([Invalidation.Script], invalidation_config)

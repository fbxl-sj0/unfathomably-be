...
defmodule Pleroma.Config.DeprecationWarningsTest do
  ...
  describe "simple policy tuples" do
    ...
    test "transforms config to tuples" do
      ...
      clear_config([:mrf_simple], mrf_simple_config)
  ...
  test "check_activity_expiration_config/0" do
    activity_expiration_config = [enabled: true]

    clear_config([Pleroma.ActivityExpiration], activity_expiration_config)
  ...
  test "check_uploders_s3_public_endpoint/0" do
    s3_config = [public_endpoint: "https://fake.amazonaws.com/bucket/"]

...
defmodule Pleroma.Web.Router do
  ...
  scope "/api/v1", Pleroma.Web.MastodonAPI do
    ...
    post(
      "/groups/:id/membership_requests/:account_id/authorize",
      FederatedGroupController,
      :authorize_membership_request
    )

    post(
      "/groups/:id/membership_requests/:account_id/reject",
      FederatedGroupController,
      :reject_membership_request
    )

    post("/groups/:id/join", FederatedGroupController, :join)
    post("/groups/:id/leave", FederatedGroupController, :leave)
    post("/groups/:id/promote", FederatedGroupController, :promote)
    post("/groups/:id/demote", FederatedGroupController, :demote)
    post("/groups/:id/kick", FederatedGroupController, :kick)
    get("/groups/:id/blocks", FederatedGroupController, :blocks)
    post("/groups/:id/blocks", FederatedGroupController, :block)
    ...
    get("/sources/search", SourceController, :search)
    get("/sources/lookup", SourceController, :lookup)
    get("/sources/relationships", SourceController, :relationships)
  ...
  scope "/api/v1", Pleroma.Web.MastodonAPI do
    ...
    get("/timelines/group/:id", FederatedGroupTimelineController, :show)

...
defmodule Pleroma.Web.ActivityPub.ObjectValidators.CommonFields do
  ...
  defmacro status_object_fields do
    quote bind_quoted: binding() do
      # Objects retain actor for legacy ActivityPub compatibility. Validators
      # keep actor and attributedTo synchronized where the object type requires it.
      field(:actor, ObjectValidators.ObjectID)

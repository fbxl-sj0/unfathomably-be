...
defmodule Pleroma.Web.ActivityPub.MRF.ForceMentionsInContent do
  ...
  defp force_mentions(object), do: object

  defp force_mentions_in_history(
         %{"formerRepresentations" => %{"orderedItems" => items}} = object
       )
       when is_list(items) do
    put_in(object, ["formerRepresentations", "orderedItems"], Enum.map(items, &force_mentions/1))
  end

  defp force_mentions_in_history(object), do: object

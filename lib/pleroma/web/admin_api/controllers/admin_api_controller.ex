...
defmodule Pleroma.Web.AdminAPI.AdminAPIController do
  ...
  def right_add_multiple(%{assigns: %{user: admin}} = conn, %{
    ...
    update = %{permission_field(permission_group) => true}
  ...
  def right_add(%{assigns: %{user: admin}} = conn, %{
      ...
      when permission_group in ["moderator", "admin"] do
    fields = %{permission_field(permission_group) => true}
  ...
  def right_delete_multiple(
    ...
    with false <- Enum.member?(nicknames, admin_nickname) do
      update = %{permission_field(permission_group) => false}
  ...
  def right_delete(
      ...
      when permission_group in ["moderator", "admin"] do
    fields = %{permission_field(permission_group) => false}

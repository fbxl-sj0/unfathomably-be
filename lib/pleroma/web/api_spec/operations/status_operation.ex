...
defmodule Pleroma.Web.ApiSpec.StatusOperation do
  ...
  def quotes_operation do
    %Operation{
      tags: ["Retrieve status information"],
      summary: "Quoted statuses",
      description: "Statuses that quote the given status",
    ...
    %Schema{
      ...
      properties: %{
        ...
        to: %Schema{
          ...
          items: %Schema{type: :string},
          description:
            "A list of nicknames or known ActivityPub actor ids (like `lain@soykaf.club`, `lain`, or `https://example.test/users/lain`) that will be used to determine who is going to be addressed by this post. Using this will disable the implicit addressing by mentioned names in the `status` body, only the people in the `to` list will be addressed. The normal rules for post visibility are not affected by this and will still apply"
        },
        group_id: %Schema{
          type: :string,
          nullable: true,

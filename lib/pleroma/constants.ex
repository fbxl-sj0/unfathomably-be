...
defmodule Pleroma.Constants do
  ...
  const(static_only_files,
    do:
      ~w(index.html robots.txt static static-fe finmoji emoji packs sounds images instance sw.js sw.mjs sw-pleroma.js manifest.webmanifest favicon.png schemas doc embed.js embed.css crypto-random-uuid.js)
  )

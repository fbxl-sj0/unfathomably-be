  ...
  def base_url do
    ...
    case uploader do
      ...
      Pleroma.Uploaders.S3 ->
        ...
        s3_base_url = public_endpoint || upload_base_url

        cond do
          is_binary(s3_base_url) and is_binary(bucket_with_namespace) ->
            Path.join([s3_base_url, bucket_with_namespace])

          is_binary(s3_base_url) ->
            s3_base_url

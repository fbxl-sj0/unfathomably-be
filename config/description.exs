...
config :pleroma, :config_description, [
  %{
    ...
    children: [
      ...
      %{
        ...
        type: {:list, :string},
        description:
          "List of MIME main types uploads are allowed to identify themselves with. Other uploaded files are still served, but identify as generic binary data. Removing types is safe. Adding types may weaken upload isolation.",
        suggestions: [
          "image",
          "audio",
          "video"
  ...
  %{
    ...
    children: [
      ...
      %{
        ...
        type: :string,
        description: "Envelope FROM address for mail sent by the server",
        suggestions: [
          "notify@example.com"
        ]
      },
  ...
  %{
    ...
    children: [
      ...
      %{
        ...
        type: :string,
        description:
          "Overrides the origin used for the internal ActivityPub fetch actor. Leave unset unless a controlled test harness needs a separate advertised origin."
      },
      %{
        key: :allow_http_fetch_actor_origin,
        type: :boolean,
        description:
          "Allows fetch_actor_origin to use plain HTTP in dev and test only. This is only intended for local smoke tests on isolated Docker networks and is ignored in production."
      },
      %{
  ...
  %{
    group: :pleroma,
    key: Pleroma.Workers.Cron.GroupDiscussionCleanupWorker,
    type: :group,
    description:
      "Purges old remote group discussion objects that have not been interacted with by a local user.",
    children: [
      %{
        key: :enabled,
        type: :boolean,
        description: "Enable daily cleanup of untouched remote group discussions.",
        suggestions: [true]
      },
      %{
        key: :max_age_days,
  ...
  %{
    ...
    children: [
      ...
      %{
        ...
        suggestions: ["unfathomably-be", :default]
      },
      %{
        key: :adapter,
        type: :keyword,
    ...
    children: [
      %{
        ...
        suggestions: [
          ...
          Pleroma.Language.Translation.Opentranslate
        ]
      },
      %{
      ...
      %{
        ...
        key: :base_url,
        label: "OpenTranslate instance URL",
        type: :string,
        suggestions: [
          "http://127.0.0.1:5000",
          "http://127.0.0.1:5000",
